-- ============================================================================
-- HIGHSTATION ULTIMATE MASTER SCHEMA V2.2 (Standard Hybrid)
-- ============================================================================
-- "The Ultimate Source of Truth" for HighStation Database
--
-- Features:
-- 1. Standard Hybrid Architecture: min_grade Column + JSONB Access Requirements
...
CREATE TABLE services (
    ...
    -- [STANDARD HYBRID]: Explicit Column for Core Logic + Extensible JSONB
    min_grade credit_grade_enum NOT NULL DEFAULT 'F',
    access_requirements JSONB DEFAULT '{"requires_openseal": false}'::JSONB,
...
-- [NEW] Auto-create profile on Auth Signup
...
-- Note: This trigger handles new signups. For existing users after a reset, 
-- a manual SYNC is required (see below).
